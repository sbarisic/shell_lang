...
public sealed class CompilationDiagnostic
{
	...
	public ShellTypeId? ExpectedType
	{
		get;
	}
	public ShellTypeId? ActualType
	{
		get;
	}
	public IReadOnlyList<string> AttemptedAdaptations
	{
		get;
	}
...
{
	public HostingDiagnostic(string code, string message)
	{
		Code = code;
		Message = message;
	}
...
public abstract record ShellResultValue
{
	...
	public sealed record Error : ShellResultValue
	{
		...
		{
			Value = value ?? throw new ArgumentNullException(nameof(value));
			Frames = frames ?? Array.Empty<ErrorContextFrame>();
		}
		public ShellValue Value
		{
			get;
		}
		public IReadOnlyList<ErrorContextFrame> Frames
		{
			get;
		}
	}
...
public sealed class RuntimeFault
{
	...
	public IReadOnlyList<ErrorContextFrame> Context
	{
		get;
	}
}
...
{
	Completed, RuntimeFault, HostFault
}
...
public sealed class ExecutionResult
{
	...
	public int CompletedStatementCount
	{
		get;
	}
}
...
{
	internal SessionUpdateResult(bool added, bool typeChanged)
	{
		Added = added;
...
public sealed class RegistrationResult
{
	...
	public IReadOnlyList<HostingDiagnostic> Diagnostics
	{
		get;
	}
}
...
{
	public IExecutionObserver? Observer
	{
		get; init;
	}
}
...
public sealed class HelpItem
{
		...
		IReadOnlyList<RuntimeFaultDescriptor>? runtimeFaults = null, IReadOnlyList<string>? members = null)
	{
		...
		Inputs = inputs ?? Array.Empty<HelpParameter>();
		Arguments = arguments ?? Array.Empty<HelpParameter>();
		Outputs = outputs ?? Array.Empty<HelpParameter>();
		ErrorType = errorType;
	...
	public IReadOnlyList<HelpParameter> Inputs
	{
		get;
	}
	public IReadOnlyList<HelpParameter> Arguments
	{
		get;
	}
	public IReadOnlyList<HelpParameter> Outputs
	{
		get;
	}
...
internal sealed class ShellArrayValue
{
	...
	public ReadOnlyCollection<ShellValue> Items
	{
		get;
	}
...
internal sealed class ShellOutputRecordValue
{
	...
	public IReadOnlyDictionary<string, ShellValue> Fields
	{
		get;
	}
